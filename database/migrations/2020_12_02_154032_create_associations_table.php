...
class CreateAssociationsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Associations", 'associations', 'association_name', 'fa-cube', [
            ["user_id", "user_id", "Dropdown", false, "", 0, 0, false, "@users"],
            ["web_site", "web site", "String", false, "", 0, 256, false],
            ["phone", "phone", "String", false, "", 0, 256, false],
            ["mobile", "mobile", "String", false, "", 0, 256, false],
            ["address", "address", "Address", false, "", 0, 256, false],
            ["association_name", "association_name", "Name", false, "", 0, 256, false],
        ]);
