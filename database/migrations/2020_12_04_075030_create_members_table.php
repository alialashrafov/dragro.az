...
class CreateMembersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Members", 'members', 'name', 'fa-cube', [
            ["association_id", "association_id", "Integer", false, "", 0, 11, false],
            ["name", "name", "Address", false, "", 0, 256, false],
            ["surname", "surname", "Address", false, "", 0, 256, false],
            ["profession", "Profession", "Name", false, "", 0, 256, false],
            ["email", "email", "Email", false, "", 0, 256, false],
            ["address", "address", "Address", false, "", 0, 256, false],
            ["image", "image", "Address", false, "", 0, 256, false],
        ]);
