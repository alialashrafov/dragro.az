...
class CreateBlogsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Blogs", 'blogs', 'title', 'fa-cube', [
            ["title", "title", "Name", false, "", 0, 256, false],
            ["content", "content", "Textarea", false, "", 0, 0, false],
            ["association_id", "association_id", "Integer", false, "", 0, 11, true],
            ["image", "image", "Name", false, "", 0, 256, false],
        ]);
