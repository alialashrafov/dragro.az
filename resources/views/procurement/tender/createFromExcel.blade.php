                                ...
                                <div class="form-list">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($products as $key=>$product)
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" name="product[{{$key}}][material_code]" value="{{$product['material_code']}}" class="form-control input-border material-code" placeholder="Material code" >
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" name="product[{{$key}}][name]" value="{{$product['name']}}"  class="form-control input-border" placeholder="Product name" >
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" name="product[{{$key}}][manufacturer]" value="{{$product['manufacturer']}}" class="form-control input-border" placeholder="Manufacturer name" >
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" name="product[{{$key}}][part_number]"  class="form-control input-border" placeholder="Part number" >
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    <input type="hidden" name="product[{{$key}}][vendor_category_id]" value="{{$product['vendor_category_id']}}" />
                                                    <input type="text" name="product[{{$key}}][pr_number]" value="{{$product['pr_number']}}"  class="form-control input-border" placeholder="PR number" >
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group half-right-radius">
                                                    <input type="text" name="product[{{$key}}][quantity]" value="{{$product['quantity']}}"  class="form-control input-border" placeholder="Enter">
                                                    <div class="input-group-btn">
                                                        <select name="product[{{$key}}][uom]" class="selectpicker form-control">
