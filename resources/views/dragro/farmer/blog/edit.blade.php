                    ...
                    <div class="block-right">
                        <div class="block-shadow">
                            ...
                            <div class="add-new-blog">
                                <form action="/{{$lang}}/association/blog/{{$Blog->id}}" method="post" enctype="multipart/form-data" class="m-0">
                                            ...
                                            <div class="row">
                                                <div class="col-md-10 col-xs-12">
                                                    <label for="blogName" class="blog-title">
                                                        <input value="{{$Blog->title}}" name="title" class="form-control" id="blogName">
                                                    </label>
                                                </div>
                                                <div class="col-md-11 col-xs-12">
                                                    <label for="blog-text" class="blog-text">
                                                        <textarea  class="form-control" id="blog-text" name="content" >{{$Blog->content}}</textarea>
                                                    </label>
                                                </div>
                                            </div>
                                            {!! csrf_field() !!}
