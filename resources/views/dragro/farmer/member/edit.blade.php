                        ...
                        <div class="block-shadow">
                            <div class="flex heading-top">
                                <h3 class="m-0">
                                    ...
                                    @lang('vendor.edit_member')
                                </h3>
                            </div>
                            <div class="add-new-blog">
                                <form action="/{{$lang}}/association/members/{{$Member->id}}" method="post" enctype="multipart/form-data" class="m-0">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-xs-12">
                                                    <label for="memberName">
                                                        ...
                                                        <input value="{{$Member->name}}" name="name" class="form-control" id="memberName">
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-xs-12">
                                                    <label for="memberSurname">
                                                        <span class="input-title">@lang('vendor.surname')</span>
                                                        <input value="{{$Member->surname}}" name="surname" class="form-control" id="memberSurname">
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-xs-12">
                                                    <label for="email">
                                                        <span class="input-title">@lang('vendor.email')</span>
                                                        <input name="email" value="{{$Member->email}}" class="form-control" id="email">
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-xs-12">
                                                    <label for="address">
                                                        <span class="input-title">@lang('vendor.address')</span>
                                                        <input value="{{$Member->address}}" name="address" class="form-control" id="address">
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-xs-12">
                                                    <label for="profession">
                                                        <span class="input-title">@lang('vendor.profession')</span>
                                                        <input type="text" value="{{$Member->profession}}" class="form-control" name="profession" id="profession">
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-xs-12">
                                                    <label for="file">
