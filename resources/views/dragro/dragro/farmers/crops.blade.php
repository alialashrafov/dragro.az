      ...
      {{--  <div class="blog-list">
        ...
        <div class="blog-list">
            <div class="table-list-heading">
                <ul class="list-unstyled flex table-list m-0">
                    <li>@lang('vendor.regions')</li>
                    <li>@lang('vendor.plantation_name')</li>
                    <li>@lang('vendor.soil_analysis')</li>
                    <li>@lang('vendor.plantation_types')</li>
                </ul>
            </div>
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingOne">
                            <ul class="list-unstyled flex table-list m-0">
                                ...
                                <li>
                                    <a href="{{$item->soil_analyses}}">File</a>
                                </li>
                                <li>
                                    <div class="flex">
                                        {{$types[$item->plantation_type]->name}}
                                       {{-- {{$plantationTypes[$item->plantation_type]}}--}}
                            ...
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->address}}</td>
                                        <td>{{$item->size }} ha</td>
                                        <td>{{$irrigation_type[$item->irrigation_type]}}</td>
