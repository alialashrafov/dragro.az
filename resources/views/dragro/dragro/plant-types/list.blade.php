                        ...
                        <div class="block-right">
                            <div class="block-shadow">
                                <div class="flex heading-top">
                                    <h3 class="m-0">@lang('vendor.plantation_types')</h3>
                                    <a href="/{{$lang}}/dragro/plantTypes/create"  class="btn-border">
                                ...
                                <div class="blog-list">
                                    @foreach($PlantationTypes as $item)
                                    <div class="blog-item flex-vertical-center">
                                        <div class="block-details flex">
                                            ...
                                            <div class="block-right-details">
                                                <a href="/{{$lang}}/dragro/plantTypes/{{$item->id}}/edit" class="btn-edit btn-transparent">
                                                ...
                                                <a href="/{{$lang}}/dragro/plantTypes/{{$item->id}}/delete" class="btn-delete btn-transparent">
