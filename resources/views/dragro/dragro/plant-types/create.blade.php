                        ...
                        <div class="block-right">
                            <div class="block-shadow">
                                ...
                                <div class="add-new-blog">
                                    <form action="/{{$lang}}/dragro/plantTypes" method="post" enctype="multipart/form-data" class="m-0">
                                        <div class="form-list">
                                            <div class="blog-content">
                                                <div class="row">
                                                    <div class="col-md-10 col-xs-12">
                                                        <label for="blogName" class="blog-title">
                                                            <input placeholder="@lang('vendor.title')" name="name" class="form-control" id="blogName">
                                                        </label>
                                                    </div>
                                                </div>
                                                {!! csrf_field() !!}
