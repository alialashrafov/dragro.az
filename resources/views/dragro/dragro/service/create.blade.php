                    ...
                    <div class="block-right">
                        <div class="block-shadow">
                            ...
                            <div class="add-new-blog">
                                <form action="/{{$lang}}/dragro/services" method="post" enctype="multipart/form-data" class="m-0">
                                    <div class="form-list">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <input type="text" class="form-control"  placeholder="@lang('vendor.price')" name="price">
                                            </div>
                                        </div>
