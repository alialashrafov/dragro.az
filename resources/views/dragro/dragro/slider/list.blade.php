                        ...
                        <div class="block-right">
                            <div class="block-shadow">
                                <div class="flex heading-top">
                                    ...
                                    <a href="/{{$lang}}/dragro/slider/create"  class="btn-border">
                                    ...
                                    <div class="blog-item flex-vertical-center">
                                        ...
                                        <div class="block-details flex">
                                            ...
                                            <div class="block-right-details">
                                                <div class="block-btn">
                                                    <a href="/{{$lang}}/dragro/slider/{{$item->id}}/edit" class="btn-edit btn-transparent">
                                                    ...
                                                    <a href="/{{$lang}}/dragro/slider/{{$item->id}}/delete" class="btn-delete btn-transparent">
